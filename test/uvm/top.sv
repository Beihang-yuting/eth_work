...
//       频率表：10g/25g/5g/40g/100g/100g4/100gr/200g/1g/2.5g，多 lane 另
//       读 +AM_SPACING）、复位/TB 控制钩子、单 lane 接口对、10 lane 接口组
//       与 GMII 口、交叉接线（含扰动/断线注入）、全部 vif 下发。速率切换
//       只换 +SPEED 插件参数，无需换 top。
