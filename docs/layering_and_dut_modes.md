...
| PCS | 完整自研：BASE-R 64b/66b（10G/25G/5G 单 lane；40G/100G MLD，100G 含 PMA 2:1/5:1 复用）；200G Clause 119（257b + RS(544,514)）；BASE-X 8b/10b（1G/2.5G，Clause 36，MAC 侧 GMII） |
